...
export function Room() {
  ...
  function handleShareRoom() {
    ...
    if (navigator.share !== undefined && navigator.canShare()) {
      ...
      toast.info('Url da sala copiada para a área de transferência.')
    }
  }

  return (
    <header className="mx-auto max-w-[640px] flex flex-col gap-6 py-10 px-4">
      ...
      <form className="flex items-center gap-2 bg-zinc-900 p-2 rounded-xl border border-zinc-800 ring-orange-400 ring-offset-2 ring-offset-zinc-950 focus-within:ring-1">
        <input
          className="bg-transparent flex-1 text-sm mx-2 outline-none placeholder:text-zinc-500 text-zinc-100 "
          autoComplete="off"
          type="text"
          name="theme"
